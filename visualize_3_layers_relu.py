...
masks = np.load("learned_phase_mask_relu.npy")
...
fig.suptitle(f"Phase 1c 3-Layer D²NN (Intensity ReLU) Forward Pass - Digit: {label}", fontsize=20, color='#f8f8f2', fontweight='bold')
...
plt.tight_layout()
plot_path = "3_layer_visualization_relu.png"
